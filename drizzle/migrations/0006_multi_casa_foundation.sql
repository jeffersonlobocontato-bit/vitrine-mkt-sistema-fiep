...
-- ============================================================
CREATE TABLE public.casa_members (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_unidades_casa ON public.unidades(casa_id);
...
CREATE INDEX idx_campanhas_casa ON public.campanhas(casa_id);
...
-- ============================================================
CREATE TABLE public.campanha_itens (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_campanha_itens_campanha ON public.campanha_itens(campanha_id);
CREATE INDEX idx_campanha_itens_unidade ON public.campanha_itens(unidade_id);
...
CREATE TABLE public.preset_reference_files (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_preset_reference_files_preset ON public.preset_reference_files(preset_id);
...
-- ============================================================
CREATE TABLE public.imagens_banco (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  casa_id uuid NOT NULL REFERENCES public.casas(id) ON DELETE CASCADE,
...
CREATE INDEX idx_imagens_banco_casa ON public.imagens_banco(casa_id);
CREATE INDEX idx_imagens_banco_campanha ON public.imagens_banco(campanha_id);
CREATE INDEX idx_imagens_banco_item ON public.imagens_banco(campanha_item_id);
...
CREATE TABLE public.stock_image_configs (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  casa_id uuid NOT NULL REFERENCES public.casas(id) ON DELETE CASCADE,
...
-- ============================================================
CREATE TABLE public.publish_channels (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  casa_id uuid NOT NULL REFERENCES public.casas(id) ON DELETE CASCADE,
